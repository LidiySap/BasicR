...
# Data frame может сочетать векторы одинаковый длины
...
# List - упорядоченная коллекция элементов и структур
# любого типа и длины. Может включать в себя в том числе данные типа list.
